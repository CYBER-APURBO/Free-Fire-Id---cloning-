...
def mail(emad, limit):
    while True:
        ...
        subDomain1m=["gamer","ff","fflover","yt","official","boss","gaming","Gaming","Gamer","FF","FFlover","freefirelover","YT","999","king","streamer","ffking"]
        subDomain2m=["pro","noob","hacker","Itz","Pro","Noob"]
        subDomain1f=["Queen","queen","gaming","streamer","FF","ff","yt","YT","ffgirl","ffqueen","freefirelover","ffyt","gamer"]
...
def main():
    ...
    print(Panel.fit("[bold green]𝐕𝐞𝐫𝐬𝐢𝐨𝐧     —>>     √1.0"))
    print("")
    print(meth)
...
def file_subb(Gmail,psslist):
    global oks,done
    sys.stdout.write(f"\r  \033[38;5;46m[𝙰𝙿𝚄𝚁𝙱𝙾-𝚇𝙳] {done}|{str(len(oks))}");sys.stdout.flush()
